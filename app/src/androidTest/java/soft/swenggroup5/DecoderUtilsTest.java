...
public class DecoderUtilsTest {
    ...
    private Byte[] VALID_CONTACT_DATA_ENCODED_WITHOUT_HEADER =
            {35, 65, 97, 97, 97, 97, 32, 66, 98, 98, 98, 32, 86, 99, 99, 99, 99, 32, 68,
    ...
    public void test_addContact_normalInput() {
        ...
        ContactData result = getResultValidContactData();
    ...
    private ContactData getResultValidContactData(){
        ContactData con = new ContactData();
